...
*/
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>AZD8871 is an investigational muscarinic antagonist/beta<sub>2</sub> agonist (MABA)</div></li><li><div>MABAs are bi-functional, single-molecule agents which combine both β<sub>2</sub>-agonism and muscarinic (M3) antagonism</div></li><li><div>AZD8871 is currently in Phase I clinical development for COPD</div></li>",
      video: "output.mp4",
    ...
    },
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>AZD7986 is an investigational DPP-1 (dipeptidyl peptidase-1) inhibitor</div></li><li><div>DPP-1 (also known as cathepsin C) is thought to act as a physiological activator or neutrophil-derived serine proteases.  DPP-1 may therefore play a role in neutrophil-dominated inflammatory diseases</div></li><li><div>AZD7896 is currently in Phase 1 clinical development for COPD</div></li>",
      video: "output.mp4",
...
*/
  ...
  phase2: [
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>Tezepelumab (MEDI9929/AMG 157) is an investigational fully human anti-thymic stromal lymphopoietin (anti-TSLP) monoclonal antibody designed to block TSLP from interacting with the TSLP receptor </div></li><li><div>TSLP is an epithelial cell‐derived cytokine that is produced in response to proinflammatory stimuli and drives inflammatory responses through its effects on multiple cell types involved in the pathobiology of asthma</div></li><li><div>Tezepelumab is currently in Phase 2 clinical development for asthma</div></li>",
      video: "output.mp4",
    ...
    },
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>AZD9412 is an investigational inhaled interferon beta-1a</div></li><li><div>Interferon beta activates downstream kinases (JAK) and transcription factors (STAT) to activate anti-viral and pro-apoptotic genes, thereby limiting viral replication</div></li><li><div>AZD9412 is currently in Phase 2 clinical development for asthma and COPD</div></li>",
      video: "output.mp4",
    ...
    },
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>PT010 is an investigational fixed‐dose, triple combination therapy containing glycopyrrolate (LAMA), formoterol fumarate (LABA), and budesonide (ICS) using co‐suspension technology, and delivered in a pMDI</div></li><li><div>Antagonism of the muscarinic receptor restores smooth muscle dilation by inhibiting the intracellular effects of inositol triphosphate</div></li><li><div>β<sub>2</sub> adrenergic receptor agonists activate adenylate cyclase, resulting a cAMP-mediated cascade, the activation of PKA, and airway smooth muscle relaxation</div></li><li><div>Activation of the glucocorticoid receptor upregulates the expression of anti-inflammatory gene transcription and suppresses pro-inflammatory gene transcription</div></li><li><div>PT010 is currently in Phase 3 clinical development for COPD and is also in Phase 2 clinical development for asthma</div></li>",
      video: "output.mp4",
    ...
    },
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>Abediterol (AZD0548) is an investigational long‐acting beta<sub>2</sub>‐agonist (LABA)</div></li><li><div>In asthma, activation of the β<sub>2</sub> receptor relaxes airway smooth muscle and may also inhibit mediator release from mast cells, prevent plasma exudation, and inhibit activation of sensory nerves</div></li><li><div>Abediterol is currently in Phase 2 clinical development for asthma and COPD</div></li>",
      video: "output.mp4",
  ...
  phase3: [
    ...
    },
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>Benralizumab (MEDI‐563) is an investigational humanized anti-IL-5 receptor alpha (anti-eosinophil) monoclonal antibody</div></li><li><div>Benralizumab is designed to bind to the alpha chain of the interleukin-5 receptor (IL-5R), enabling effector cells to induce the apoptosis of and thereby depleting eosinophils via antibody-dependent cell-mediated cytotoxicity (ADCC)</div></li><li><div>The constant region (Fc) of benralizumab is afucosylated, leading to increased affinity for the Fc gamma receptor 3 (FcγRIIIa) found on the surface of effector cells, such as natural killer cells</div></li><li><div>Benralizumab is currently in Phase 3 clinical development for severe asthma and COPD</div></li>",
      video: "output.mp4",
    ...
    */
    {
      ...
      assetsEnd: 75,
      duration: 5,
      text: "<li><div>Tralokinumab (CAT‐354) is an investigational human monoclonal antibody designed to neutralize IL-13</div></li><li><div>Interleukin 13 (IL-13) is a cytokine that is believed to play a key role in the pathogenesis of asthma and is predominantly produced by T helper 2 cells, although various other immune cells are also capable of its release in the lung tissue, including eosinophils, natural killer cells, mast cells, basophils, and injured epithelial cells.</div></li><li><div>IL-13 overexpression has been associated with Th2-driven inflammation airway hyperresponsiveness and mucus hypersecretion from goblet cells</div></li><li><div>Tralokinumab is currently in Phase 3 clinical development for severe asthma </div></li>",
      video: "output.mp4",
